	...
	$metadata = [
		...
		'tiktok' => [
			...
			'icon' => '
				...
				height="20px"
				viewBox="0 0 20 20">
					<path d="M19,4.4c-2.4-0.2-4.3-2-4.6-4.4l0-0.3h-3.6l0,0.4c0,0,0,13.9,0,14c0,1.5-1.3,2.7-2.9,2.7c-1.5,0-2.7-1.2-2.7-2.7s1.2-2.7,2.7-2.7c0.1,0,0.2,0,0.2,0l0.5,0.1V7.9L8.6,7.6l-0.3,0c-0.1,0-0.2,0-0.3,0c-3.6,0-6.5,2.9-6.5,6.5c0,3.6,2.9,6.5,6.5,6.5c3.6,0,6.5-2.9,6.5-6.5V6.8c1.1,1.1,2.5,1.7,4.1,1.7c0.2,0,0.4,0,0.5,0l0.3,0v-4L19,4.4z"/>
				</svg>
			',
		],
