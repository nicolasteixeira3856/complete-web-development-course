...
// footer button
$horizontal_alignment = blocksy_akg( 'footer_button_horizontal_alignment', $atts, 'flex-start' );
...
$vertical_alignment = blocksy_akg( 'footer_button_vertical_alignment', $atts, 'CT_CSS_SKIP_RULE' );
